...
@Autonomous(name = "BlueDrivingAutonomous")
public class BlueDrivingAutonomous extends LinearOpMode {
    ...
    /*
    Blue version of RedDrivingAutonomous. Drives backwards into warehouse.
     */
    @Override
